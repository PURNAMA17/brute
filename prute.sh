...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" ALVAHROZI PURNAMA  "$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Alvahrozi Purnama"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.ALVAH]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [muhammad faisal]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 088708371407"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" ojil40000@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 089505649048"
echo $ku"Facebook :"$i" alvahrozi purnama"
sleep 2
